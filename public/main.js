...
/* ───────────── faq ───────────── */
const FAQS=[
  {q:"Antalya'da boşanma davası nasıl açılır?",a:'Boşanma davası, eşlerden birinin son altı aydır oturduğu veya eşlerin son altı aydır birlikte oturdukları yer aile mahkemesinde açılır. Anlaşmalı boşanmada ortak bir protokol hazırlanırken, çekişmeli boşanmada dava dilekçesi ve deliller hukuki stratejiye göre düzenlenir. Sürecin ayrıntıları <a href="/antalya-bosanma-avukati/">boşanma dosyalarında izlenen yol</a> sayfasında anlatılmıştır.'},
  {q:'Ceza davalarında avukat tutmak zorunlu mudur?',a:'Kural olarak zorunlu değildir; ancak alt sınırı beş yıldan fazla hapis cezası gerektiren suçlarda ve bazı hallerde mahkeme zorunlu müdafi atar. Soruşturmanın ilk aşamasından itibaren avukatla çalışmak, hak kayıplarının önüne geçer. Savunmanın aşamalara göre nasıl kurulduğu <a href="/antalya-ceza-avukati/">soruşturma ve kovuşturmada temsil</a> sayfasında ele alınmıştır.'},
  {q:'Avukatlık ücreti neye göre belirlenir?',a:'Ücret; işin niteliği, kapsamı, harcanacak emek ve süre ile Avukatlık Asgari Ücret Tarifesi dikkate alınarak belirlenir. Görüşme öncesi şeffaf bir ücretlendirme sunulur ve sözleşmeyle netleştirilir. Ücretlendirme ve randevu için <a href="/iletisim">görüşme talebi</a> iletilebilir.'},
  {q:'Online hukuki danışmanlık veriliyor mu?',a:'Evet. Yüz yüze görüşmenin yanı sıra telefon ve çevrim içi görüşme seçenekleri sunulmaktadır. Şehir dışında bulunan müvekkiller için dosya süreci çevrim içi de yürütülebilir. Büronun konumu ve görüşme düzeni <a href="/konyaalti-avukat/">Konyaaltı ofisine ilişkin sayfada</a> yer alır.'},
  {q:'Yabancılar Türkiye’de gayrimenkul satın alabilir mi?',a:'Belirli ülke vatandaşları için kısıtlamalar bulunsa da yabancılar, askeri ve güvenlik bölgeleri dışında kalan taşınmazları edinebilir. Tapu işlemleri öncesi hukuki inceleme, ileride doğabilecek uyuşmazlıkları önler. Taşınmaz uyuşmazlıklarında izlenen yol <a href="/antalya-gayrimenkul-ve-kira-avukati/">tapu ve kira dosyaları</a> sayfasında açıklanmıştır.'},
  {q:'İcra takibinde süreler neden önemlidir?',a:'İcra ve iflas hukukunda itiraz, şikâyet ve dava açma süreleri kesindir; kaçırılması ciddi hak kayıplarına yol açar. Bu nedenle tebligatın ardından vakit kaybetmeden hukuki destek alınması önerilir. Takip ve itiraz sürecinin işleyişi <a href="/antalya-icra-avukati/">icra dosyalarının takibi</a> sayfasında ele alınmıştır.'}
];
