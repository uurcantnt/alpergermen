# -*- coding: utf-8 -*-
"""İİK m.114 — ortaklığın giderilmesi ihalesi (7589 sayılı Kanun). Türkçe içerik.

Bent metinleri 31 Temmuz 2026 tarihli Resmî Gazete'den birebir alınmıştır.
"""

SLUG = "yazilar/ortakligin-giderilmesi-ihalesinde-yeni-kurallar"
TITLE = "Ortaklığın Giderilmesinde İhale Kuralları | Av. Alper Germen"
DESC = ("7589 sayılı Kanunla İİK m.114 değişti: mirasçılar arasında birinci artırma, "
        "%100 teklif eşiği, teminat muafiyeti ve bedeli yatırmayana idari para cezası.")
H1 = "Ortaklığın Giderilmesi İhalesinde Yeni Kurallar (7589 Sayılı Kanun)"
KICKER = "İcra ve İflas Hukuku"
ARTICLE_SECTION = "İcra ve İflas Hukuku"
...
OZET = ("31 Temmuz 2026'da yürürlüğe giren 7589 sayılı Kanun, İcra ve İflâs Kanunu'nun 114. "
        "maddesini değiştirerek ortaklığın satış suretiyle giderilmesi ihalelerine yeni bir usul "
        "getirdi. Miras yoluyla edinilen taşınmazlarda birinci artırma yalnızca malik mirasçılar "
        "arasında yapılacak; bu artırmada teklif eşiği muhammen kıymetin yüzde yüzü olacak. "
        "Değişiklik, yürürlükten önce ilanı yapılmış artırmalara uygulanmaz.")

GIRIS = [
 ("Düzenleme, kamuoyunda 12. Yargı Paketi olarak anılan 7589 sayılı Yargının Etkin ve Verimli "
  "İşlemesine Yönelik Bazı Kanunlarda Değişiklik Yapılmasına Dair Kanunun 1. maddesiyle geldi. "
  "Kanun 31 Temmuz 2026 tarihli, 33326 sayılı Resmî Gazete'de yayımlanarak aynı gün yürürlüğe girdi."),
 ("Bu yazı paketin tamamını değil, İcra ve İflâs Kanunu'nun 114. maddesinde yapılan değişikliği ve "
  "bunun ortaklığın giderilmesi (izale-i şüyu) dosyalarına etkisini ele alıyor. Büronun bu alandaki "
  "çalışmaları <a href=\"/antalya-icra-avukati/\">Antalya icra avukatı</a> sayfasında anlatılmıştır."),
 ("Değişikliğin arkasındaki sorun bilinmektedir: miras yoluyla intikal eden taşınmazlarda açılan "
  "ortaklığın giderilmesi davaları sonunda yapılan ihalelerde, taşınmaz çoğu zaman üçüncü kişilere "
  "düşük bedelle satılmakta, paydaş mirasçılar aile taşınmazını kaybetmekteydi. Yeni kural bu "
  "dosyalarda mirasçılara öncelik tanımaktadır."),
]

BOLUMLER = [
 ("İİK m.114'te ne değişti?", [
   "Kanunun 1. maddesiyle İcra ve İflâs Kanunu'nun 114. maddesinin ikinci fıkrasına yeni cümleler "
   "eklendi ve yedinci fıkranın (6), (8) ve (9) numaralı bentleri değiştirildi.",
   "Madde 114, artırma ilanı ve elektronik satış portalında yapılacak açık artırmanın esaslarını "
   "düzenler. Bu nedenle değişiklik yalnızca ortaklığın giderilmesi dosyalarını değil, haciz yoluyla "
   "yapılan satışları da ilgilendirmektedir; ancak en belirgin yenilik ortaklığın giderilmesi "
   "bakımından getirilmiştir.",
   "Aşağıda önce mirasçılara tanınan öncelik, ardından teklif eşikleri, teminat kuralları ve ihale "
 ...
 ("Birinci artırma yalnızca malik mirasçılar arasında", [
   ...
   "Bunun karşılığında ise, aşağıda görüleceği üzere, bu artırmada oldukça yüksek bir teklif eşiği "
   "öngörülmüştür."]),

 ("Teklif eşikleri: yüzde yüz ve yüzde elli", [
 ...
 ("Vesayet altındaki kişilerin taşınmaz satışı", [
 ...
 ("Geçiş hükmü: hangi ihalelere uygulanır?", [
   ...
   "gerektirir. İlan tarihi, mirasçılara tanınan önceliğin o dosyada kullanılıp kullanılamayacağını "
   "doğrudan belirler."]),
 ...
 ("Paydaşlar için pratik adımlar", [
   ...
   "<a href=\"/antalya-gayrimenkul-ve-kira-avukati/\">Antalya gayrimenkul avukatı</a> sayfası incelenebilir."]),
]

SSS = [
 ("Ortaklığın giderilmesi ihalesine kimler katılabilir?",
  "Tüm maliklerin miras yoluyla edindiği ve mirasçılar dışında üçüncü kişilerin mülkiyet hakkının "
  "bulunmadığı taşınmazlarda birinci artırma sadece malik olan mirasçılar arasında yapılır. Bu usul "
  "bir defaya mahsustur; ikinci artırma genel kurallara tabidir."),
 ("Birinci artırmada en az ne kadar teklif verilmelidir?",
  "Birinci artırmanın sadece malik mirasçılar arasında yapıldığı durumlarda teklifin, taşınmazın "
  "muhammen kıymetinin yüzde yüzünü geçmesi gerekir. İkinci artırmada eşik yüzde elliye döner."),
 ("Değişiklik ne zaman yürürlüğe girdi?",
  "7589 sayılı Kanun 31 Temmuz 2026 tarihli, 33326 sayılı Resmî Gazete'de yayımlanarak aynı gün "
  "yürürlüğe girmiştir. Türk Medenî Kanunu'nun 440 ve 444. maddelerine ilişkin değişiklikler ise "
  "yayımı tarihinden üç ay sonra yürürlüğe girmiştir."),
 ("Devam eden dosyalarda yeni kurallar uygulanır mı?",
  "Değişiklikler, yürürlük tarihinden önce ilanı yapılmış açık artırmalar hakkında uygulanmaz. "
  "Belirleyici ölçüt artırma ilanının tarihidir; davanın veya kararın tarihi değildir."),
 ("Alacaklı teminat yatırmadan artırmaya katılabilir mi?",
  "Satış talep eden ve artırmaya katılmak isteyen alacaklı, en geç artırma süresinin bitiminden "
  "önceki iş günü mesai bitimine kadar satışı yapan icra dairesine müracaat ederse, alacağın "
  "teminatı karşıladığı miktar kadar kendisinden teminat alınmaz. Hazine ise açık artırmalarda "
  "teminat göstermekten muaftır."),
 ("İhale bedeli süresinde yatırılmazsa ne olur?",
  "Alınan teminat iade edilmez; önce satış masraflarından mahsup edilir. Ortaklığın giderilmesinde "
  "kalan tutar paydaşlara payları oranında ödenir; bedeli yatırmayan kişi paydaş ise teminatın "
  "tamamı diğer pay sahiplerine payları oranında ödenir. Ayrıca teklif edilen bedelin yüzde beşi "
  "oranında idari para cezası verilir."),
 ("Paydaşlardan biri vesayet altındaysa satış nasıl yapılır?",
  "Türk Medenî Kanunu'nun değişik 444. maddesi uyarınca satış, Ulusal Yargı Ağı Bilişim Sistemine "
  "entegre elektronik satış portalında açık artırmayla yapılır ve ihale vesayet makamının onamasıyla "
  "tamam olur. Onamaya ilişkin kararın ihale gününden başlayarak on gün içinde verilmesi gerekir."),
]

KAPANIS = [
 "Yeni usul, miras yoluyla intikal eden taşınmazlarda paydaş mirasçılara belirgin bir öncelik "
 "tanımaktadır; ancak bu önceliğin bedeli, birinci artırmadaki yüzde yüzlük teklif eşiğidir. Bu "
 "nedenle kıymet takdiri aşaması, dosyanın sonucunu doğrudan etkileyen aşama hâline gelmiştir.",
 "Büronun çalışma alanları <a href=\"/alanlar\">çalışma alanları sayfasında</a> yer almaktadır. "
 "Satış aşamasındaki bir dosya için değerlendirme talep etmek isteyenler "
 "<a href=\"/iletisim\">iletişim sayfası</a> üzerinden büroya ulaşabilir.",
]

UYARI = ("Bu yazı yalnızca genel bilgilendirme amacıyla hazırlanmıştır; hukuki görüş veya tavsiye "
         "niteliği taşımaz. Ortaklığın giderilmesi dosyalarında sonuç, tapu kaydına, payların ediniliş "
         "biçimine ve artırma ilanının tarihine göre değişir. Somut bir dosya için avukata başvurulması "
         "gerekir.")
