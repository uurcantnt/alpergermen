# -*- coding: utf-8 -*-
"""Article 31 TPC — criminal responsibility of minors (law no. 7593). English content."""

SLUG = "en/yazilar/criminal-responsibility-of-minors-turkey"
TITLE = "Criminal Responsibility of Minors | Av. Alper Germen"
DESC = ("Law no. 7593 amended article 31 of the Turkish Penal Code: sentence ranges rose for "
        "both age bands and a new paragraph lets the age reduction be disapplied.")
H1 = "Article 31 TPC: The 2026 Change to the Criminal Responsibility of Minors"
KICKER = "Criminal Law"
ARTICLE_SECTION = "Criminal Law"
...
OZET = ("Article 31 of the Turkish Penal Code, which governs minority of age, was amended by law "
        "no. 7593, in force since 18 August 2026. Sentence ranges were raised for both the 12-15 "
        "and the 15-18 age groups, and a new paragraph allows the age reduction to be disapplied "
        "in cases of intentional killing and aggravated injury by result. As the change is "
        "unfavourable to the defendant, it does not operate retrospectively.")

GIRIS = [
 ("The change was introduced by law no. 7593, the Law Amending the Child Protection Law and Certain "
  "Other Laws. It was passed by the Grand National Assembly on 8 August 2026 and published in the "
  "Official Gazette of 18 August 2026, issue 33344, entering into force the same day."),
 ("This article deals not with the child protection limb of the package but with the provisions "
  "bearing directly on criminal responsibility: the sentence ranges in article 31 of the Turkish "
  "Penal Code, the paragraph added to that article, and the changes to the execution regime. The "
  "office's work in this field is set out on our "
  "<a href=\"/en/antalya-criminal-lawyer/\">Antalya criminal lawyer</a> page."),
 ("One point deserves emphasis: this is not an amnesty or a reduction. On the contrary, it raises "
  "the sentence ranges applicable to children and allows the age reduction to be withheld in "
  "specified offences."),
]
...
BOLUMLER = [
 ...
 ("The new fourth paragraph: disapplying the age reduction", [
   ...
   "the wording is \"may be disapplied\". Showing in the reasons which criterion rests on which "
   "established fact will accordingly become the central issue on appeal."]),
 ...
 ("The converse: applying the third paragraph to younger children", [
   ...
   "expected to be assessed together with the social investigation report and findings on the child's "
 ...
 ("Points that come to the fore in the defence", [
   ...
   "Children's files in Antalya are heard by the children's courts and the children's assize court at "
   "the Antalya Courthouse. On rights during the investigation stage and the route followed, see our "
   "<a href=\"/en/antalya-criminal-lawyer/\">Antalya criminal lawyer</a> page."]),
]

SSS = [
 ("When was article 31 TPC amended?",
  "Article 31 of the Turkish Penal Code was amended by law no. 7593, passed on 8 August 2026. The "
  "amendment was published in the Official Gazette of 18 August 2026, issue 33344, and entered into "
  "force the same day."),
 ("Have sentences for children increased?",
  "Yes. Post-reduction sentence ranges were raised in both the twelve to fifteen and the fifteen to "
  "eighteen bands. The ceilings applying to other sentences rose from seven to nine years and from "
  "twelve to fifteen years respectively. The rates of reduction, one half and one third, are unchanged."),
 ("Can a fifteen-year-old be sentenced as an adult?",
  "The new fourth paragraph provides that, in cases of intentional killing (arts. 81, 82) and injury "
  "aggravated by result (art. 87/2 and 4), the third paragraph may be disapplied in respect of the "
  "fifteen to eighteen band, having regard to one or more of the four listed criteria. This is a "
  "discretion, not a duty."),
 ("What happens to children under twelve?",
  "Children who have not completed the age of twelve at the time of the act bear no criminal "
  "responsibility and no prosecution may be brought. Only security measures specific to children may "
  "be applied. Law no. 7593 did not change this rule."),
 ("Does the change apply to existing files?",
  "No. Because the changes are unfavourable to the defendant, the principle of the more favourable law "
  "in article 7 of the Turkish Penal Code means they do not apply to acts committed before 18 August "
  "2026. The governing criterion is the date of the act, not the date proceedings were issued."),
 ("Where do child convicts serve their sentences?",
  "Sentences of child convicts sentenced to a total of three years or less for intentional offences, or "
  "five years or less for negligent offences, are carried out directly in children's education houses. "
  "In cases such as absconding, detention or a final disciplinary penalty, they are sent to a closed "
  "penal institution for children by decision of the administration and observation board."),
 ("Is a social investigation report mandatory?",
  "A social investigation is mandatory for children under fifteen. An indictment drawn up without one "
  "is returned under the subparagraph added to article 174 of the Criminal Procedure Code. Where no "
  "investigation is carried out for a child who has reached fifteen, the reasons must be stated in the "
  "indictment or in the judgment."),
]

KAPANIS = [
 "The first practical consequence in children's files is that the date of the act and the child's age "
 "must be established with precision at the outset. Together these two elements determine which "
 "paragraph, and which version of the text, applies.",
 "The child protection measures and the administrative sanctions on carrying knives introduced by the "
 "same law are separate subjects. The office's fields of work are set out on our "
 "<a href=\"/en/alanlar\">practice areas page</a>, and requests for an assessment of a particular file "
 "are dealt with through the <a href=\"/en/iletisim\">contact page</a>.",
]

UYARI = ("This article has been prepared for general information only and does not constitute legal "
         "opinion or advice. In children's files the outcome depends on the date of the act, the age of "
         "the child, the social investigation report and the state of the evidence. A lawyer should be "
         "consulted in relation to any particular file.")
